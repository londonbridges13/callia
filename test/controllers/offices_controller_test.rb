...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { name: @office.name, office_code: @office.office_code, telephone: @office.telephone }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { name: @office.name, office_code: @office.office_code, telephone: @office.telephone }
    assert_redirected_to office_path(assigns(:office))
  end
